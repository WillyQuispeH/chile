...
export default function HeroGeometric({
  ...
  const buttons = [
    {
      name: "YouTube",
      href: "https://youtube.com/shorts/vUADB2TmIo4?si=Ue7XaJ3lg5Y8SFHR",
    ...
    {
      name: "TikTok",
      href: "https://www.tiktok.com/@ibaillanos/video/7545908100889316630?is_from_webapp=1&sender_device=pc&web_id=7390855316623508997",
    ...
    {
      name: "Instagram",
      href: "https://www.instagram.com/p/DOJcwO-DOnC/",
    ...
    {
      name: "Facebook",
      href: "https://www.facebook.com/share/r/1BFVZVREME/",
        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            <h1 className="text-4xl sm:text-6xl md:text-8xl font-bold mb-6 md:mb-8 tracking-tight">
              ...
              <span
                className={cn(
                  "bg-clip-text text-transparent bg-gradient-to-r from-red-600 via-white to-blue-600",
                  pacifico.className
                )}
              >
                {title2}
          ...
          >
            <p className="text-[15px] sm:text-lg md:text-xl text-white mb-8 leading-relaxed font-light tracking-wide max-w-xl mx-auto px-4">
              ¡Que todo el mundo vea el sabor de Chile! Mira el reel, busca el
              comentario CHILE de Ibai y dale like. ¡Hagamos que nuestra
              tradición brille!
            </p>
          </motion.div>
